...
The timing results for~\cite{ATLAS_SUSY_1Lbb_pallet} over multiple trials are summarized in~\Cref{table:performance} along with the results from additional analyses that have published probability models as \pyhf{} pallets on HEPData.
